...
import { Phone, MapPin, Mail, Clock, Facebook, Instagram, MessageCircle, Send, Building } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Ready to elevate your game? Get in touch with Sri Lanka's #1 sports equipment distributor. Our expert team
              is here to help you find the perfect equipment for your needs.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              <div className="mb-8">
                <Badge className="bg-[#003DA5] text-white px-4 py-2 text-sm font-bold mb-4">SEND MESSAGE</Badge>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-2">Sport Category</label>
                  <select
                    name="sport"
            ...
            <div>
              <div className="mb-8">
                <Badge className="bg-[#FFD700] text-[#1A1A1A] px-4 py-2 text-sm font-bold mb-4">VISIT OUR STORE</Badge>
                <h2 className="text-3xl md:text-4xl font-black text-[#1A1A1A] mb-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600">Product Display, Expert Consultation, Bulk Orders</p>
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <div className="mt-6">
                ...
                <div className="flex gap-4">
                  <Button size="sm" className="bg-[#1877F2] hover:bg-[#1877F2]/90 text-white rounded-full p-3">
