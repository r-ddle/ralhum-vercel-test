                    ...
                    {verificationStatus.type === 'not-found' && (
                      <Alert className="bg-white border-red-200">
                        ...
                        <AlertDescription>
                          ...
                          Sports and it's not showing as verified, please contact our support team
                          immediately as this may indicate a quality control issue.
                        </AlertDescription>
                      </Alert>
                    )}
                  </div>
            ...
            <CardContent className="p-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                  As Sri Lanka's #1 sports equipment distributor, we're committed to ensuring every
                  customer receives authentic, high-quality products. Our verification system helps
                  protect you from counterfeit sports equipment that may be unsafe or perform
                  poorly.
                </p>
