        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <Badge className="bg-[#1A1A1A] text-[#FFD700] px-6 py-2 text-sm font-bold">INNOVATION LEADER</Badge>
            </div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Discover the complete Molten collection. As the official supplier for Olympic Games and World
              Championships, Molten provides the highest quality balls and equipment for basketball and volleyball.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Professional basketball and volleyball equipment trusted by Olympic athletes and teams worldwide.
            </p>
          </div>

          <div className="space-y-16">
            {moltenProducts.map((category, categoryIndex) => (
              <div key={category.category}>
                {/* Category Header */}
                <div className="text-center mb-12">
                  <h3 className="text-3xl md:text-4xl font-black text-[#FFD700] mb-4">{category.category}</h3>
      ...
      <section className="py-16 bg-gradient-to-r from-[#FFD700] to-[#FF3D00] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Contact our basketball and volleyball specialists for equipment recommendations and team pricing.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <WhatsAppButton
              size="lg"
