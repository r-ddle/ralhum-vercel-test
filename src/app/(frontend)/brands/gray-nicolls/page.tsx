        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Discover the complete range of Gray-Nicolls cricket equipment. From professional-grade
              bats to essential protective gear, we offer everything you need to excel on the
              cricket field.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Professional cricket equipment trusted by players worldwide, from grassroots to
              international level.
            </p>
          </div>

          <div className="space-y-16">
            {grayNicollsProducts.map((category) => (
                  ...
                  {category.products.map((product) => (
                    ...
                    >
                      <CardContent className="p-6">
                        ...
                        {/* Features */}
                        <div className="mb-4">
                          <h5 className="font-bold text-[#003DA5] dark:text-[#4A90E2] mb-2 text-sm">
                            KEY FEATURES:
                          </h5>
      ...
      <section className="py-16 bg-gradient-to-r from-[#003DA5] to-[#FF3D00] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-black mb-4">
            READY TO UPGRADE YOUR CRICKET GEAR?
          </h2>
          <p className="text-xl mb-8 opacity-90">
            Contact our cricket equipment specialists for personalized recommendations and bulk
            order pricing.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <WhatsAppButton
