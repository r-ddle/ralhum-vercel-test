    ...
    <main className="min-h-screen pt-16 bg-white dark:bg-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 relative z-10">
          ...
          <div className="text-center">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <Badge className="bg-[#FFD700] text-[#1A1A1A] px-6 py-2 text-sm font-bold">SINCE 1823</Badge>
            </div>
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
              Explore the complete Gilbert rugby collection. As the official Rugby World Cup ball supplier, Gilbert
              provides the highest quality equipment for players at every level.
            </p>
      ...
      <section className="py-20 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="bg-[#FF3D00] text-white px-6 py-2 text-sm font-bold mb-4">PRODUCT CATEGORIES</Badge>
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              Professional rugby equipment trusted by teams worldwide, from grassroots to Rugby World Cup level.
            </p>
          </div>

          <div className="space-y-16">
            {gilbertProducts.map((category, categoryIndex) => (
              <div key={category.category}>
                {/* Category Header */}
                <div className="text-center mb-12">
                  <h3 className="text-3xl md:text-4xl font-black text-[#FF3D00] mb-4">{category.category}</h3>
      ...
      <section className="py-16 bg-gradient-to-r from-[#FF3D00] to-[#003DA5] text-white">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl md:text-4xl font-black mb-4">READY TO ELEVATE YOUR RUGBY GAME?</h2>
          <p className="text-xl mb-8 opacity-90">
            Contact our rugby equipment specialists for personalized recommendations and team order pricing.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <WhatsAppButton
              size="lg"
