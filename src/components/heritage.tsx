    ...
    <section className="py-20 bg-[#1A1A1A] text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          <Badge className="bg-[#FFD700] text-[#1A1A1A] px-6 py-2 text-sm font-bold mb-4">OUR HERITAGE</Badge>
          <h2 className="text-4xl md:text-6xl font-black mb-6">
            25+ YEARS OF
            <span className="block text-[#FF3D00]">ATHLETIC EXCELLENCE</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-3xl mx-auto">
            From humble beginnings to Sri Lanka's leading sports equipment distributor, our journey is built on trust,
            quality, and unwavering commitment to sports excellence.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          {stats.map((stat, index) => (
            <div key={index} className="text-center">
              <div className={`text-5xl md:text-6xl font-black mb-2 ${stat.color}`}>{stat.number}</div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-[#003DA5]/20 to-[#FF3D00]/20 border border-white/10 rounded-2xl p-8 backdrop-blur-sm">
            ...
            <p className="text-xl text-gray-300 mb-6 max-w-4xl mx-auto">
              Our parent company, S.M.M.Muhlar & Co, has been a trusted name in Sri Lankan business for over 75 years.
              This heritage of excellence and integrity forms the foundation of everything we do at Ralhum Sports.
            </p>
