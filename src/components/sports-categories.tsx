    ...
    <section className="py-20 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <Badge className="bg-[#FF3D00] text-white px-6 py-2 text-sm font-bold mb-4">SPORTS CATEGORIES</Badge>
          <h2 className="text-4xl md:text-6xl font-black text-[#1A1A1A] mb-6">
            EVERY SPORT,
            <span className="block text-[#003DA5]">EVERY LEVEL</span>
          </h2>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            From school teams to professional athletes, we supply equipment for every sport and skill level
          </p>
        </div>
              ...
              <CardContent className="p-0">
                ...
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 right-4">
                    ...
                    <Badge className="bg-white/20 text-white border-white/30">{sport.featured}</Badge>
                  </div>
                </div>
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-[#003DA5] to-[#FF3D00] rounded-2xl p-8 text-white">
            ...
            <Button size="lg" className="bg-white text-[#003DA5] hover:bg-gray-100 font-bold px-8 py-4 rounded-full">
              CONTACT OUR TEAM
            </Button>
          </div>
        </div>
