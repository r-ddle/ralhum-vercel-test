...
export const products: Product[] = [
  // Cricket Products
  {
    ...
    shortDescription:
      "Professional English willow cricket bat with traditional profile",
    brand: brands[0],
    categories: [categories[0]],
    images: [
      {
        id: "1",
        url: "/placeholder.svg?height=400&width=400&text=Cricket+Bat",
  ...
  },
  {
    ...
    images: [
      {
        id: "2",
        url: "/placeholder.svg?height=400&width=400&text=Cricket+Helmet",
  ...
  // Rugby Products
  {
    ...
    images: [
      {
        id: "3",
        url: "/placeholder.svg?height=400&width=400&text=Rugby+Ball",
  ...
  // Basketball Products
  {
    ...
    shortDescription:
      "Official FIBA approved basketball with premium construction",
    brand: brands[2],
    categories: [categories[2]],
    images: [
      {
        id: "4",
        url: "/placeholder.svg?height=400&width=400&text=Basketball",
  ...
  // Hockey Products
  {
    ...
    images: [
      {
        id: "5",
        url: "/placeholder.svg?height=400&width=400&text=Hockey+Stick",
  ...
  // Tennis Products
  {
    ...
    shortDescription:
      "Official ATP Tour tennis balls with premium construction",
    brand: brands[4],
    categories: [categories[5]],
    images: [
      {
        id: "6",
        url: "/placeholder.svg?height=400&width=400&text=Tennis+Balls",
